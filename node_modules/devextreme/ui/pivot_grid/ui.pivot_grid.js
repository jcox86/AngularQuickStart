...
var PivotGrid = Widget.inherit({
    ...
    _updateScrollPosition: function(columnsArea, rowsArea, dataArea) {
        ...
        if (null !== that._scrollTop || null !== that._scrollLeft || scrolled) {
    ...
    _createTableElement: function() {
        ...
        return $("<table>").css({
            width: "100%"
        }).toggleClass(BORDERS_CLASS, !!that.option("showBorders")).toggleClass("dx-word-wrap", !!that.option("wordWrapEnabled")).on(eventUtils.addNamespace(clickEvent.name, "dxPivotGrid"), "td", $.proxy(that, "_handleCellClick"))
    },
