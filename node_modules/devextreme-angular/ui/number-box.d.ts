...
export declare class DxNumberBoxComponent extends DxComponent implements OnDestroy, AfterViewInit, ControlValueAccessor {
    ...
    invalidValueMessageChange: any;
    maxChange: any;
    minChange: any;
    modeChange: any;
    showSpinButtonsChange: any;
    stepChange: any;
    change(_: any): void;
    touched: () => void;
